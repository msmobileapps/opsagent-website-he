...
const kpiCards = [
  { icon: Target, label: 'Active Agents', value: '2', trend: 0, color: 'text-blue-400', bg: 'bg-blue-500/10' },
...
export default function DemoClientOverview() {
  return (
    <div>
      <div className="mb-8 flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-bold text-white">Operations Overview — Demo Corp</h1>
